 ...
 * @hide
 */
public class TrayPreferenceFrameLayout extends FrameLayout {
    ...
    public TrayPreferenceFrameLayout(Context context) {
        this(context, null);
    }

    public TrayPreferenceFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.trayPreferenceFrameLayoutStyle);
    }

    public TrayPreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public TrayPreferenceFrameLayout(
            Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.TrayPreferencesFrameLayout, defStyleAttr, defStyleRes);
        ...
        mBorderTop = a.getDimensionPixelSize(
                R.styleable.TrayPreferencesFrameLayout_borderTop,
                defaultBorderTop);
        mBorderBottom = a.getDimensionPixelSize(
                R.styleable.TrayPreferencesFrameLayout_borderBottom,
                defaultBottomPadding);
        mBorderLeft = a.getDimensionPixelSize(
                R.styleable.TrayPreferencesFrameLayout_borderLeft,
                defaultLeftPadding);
        mBorderRight = a.getDimensionPixelSize(
                R.styleable.TrayPreferencesFrameLayout_borderRight,
                defaultRightPadding);
    ...
    public void addView(View child) {
        ...
        LayoutParams layoutParams = params instanceof TrayPreferenceFrameLayout.LayoutParams
            ? (TrayPreferenceFrameLayout.LayoutParams) child.getLayoutParams() : null;
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.TrayPreferencesFrameLayout_Layout);
            removeBorders = a.getBoolean(
                    R.styleable.TrayPreferencesFrameLayout_Layout_layout_removeBorders,
                    false);
            a.recycle();
        }
