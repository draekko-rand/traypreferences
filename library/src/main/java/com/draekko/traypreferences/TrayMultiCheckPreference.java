 ...
 */
public class TrayMultiCheckPreference extends TrayDialogPreference {
    ...
    public TrayMultiCheckPreference(
        ...
        setEntryValuesCS(a.getTextArray(
                R.styleable.TrayListPreferences_entryValues));
        a.recycle();
        ...
        a = context.obtainStyledAttributes(attrs,
                R.styleable.TrayPreferences, 0, 0);
        mSummary = a.getString(R.styleable.TrayPreferences_summary);
        a.recycle();
    }

    public TrayMultiCheckPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public TrayMultiCheckPreference(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.trayDialogPreferenceStyle);
    }

    public TrayMultiCheckPreference(Context context) {
        this(context, null);
    }
