 ...
 *            Must implement {@link TrayGenericInflater.Parent}
 */
abstract class TrayGenericInflater<T, P extends TrayGenericInflater.Parent> {
     ...
     *            retrieved.
     */
    protected TrayGenericInflater(Context context) {
        mContext = context;
    }
     ...
     */
    protected TrayGenericInflater(TrayGenericInflater<T,P> original, Context newContext) {
        mContext = newContext;
     ...
     * the given Context.
     */
    public abstract TrayGenericInflater cloneInContext(Context newContext);
