 ...
 */
public class TrayPreferenceImageView extends ImageView {

    public TrayPreferenceImageView(Context context) {
        this(context, null);
    }

    public TrayPreferenceImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TrayPreferenceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
