...
/**
 * The {@link TrayYesNoPreference} is a preference to show a dialog with Yes and No
 * buttons.
 * <p>
 * This preference will store a boolean into the SharedPreferences.
 */
public class TrayYesNoPreference extends TrayDialogPreference {
    private boolean mWasPositiveResult;

    public TrayYesNoPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public TrayYesNoPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public TrayYesNoPreference(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.trayYesNoPreferenceStyle);
    }

    public TrayYesNoPreference(Context context) {
        this(context, null);
    }
