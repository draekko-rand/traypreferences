...
import com.draekko.traypreferences.util.XmlUtils;
 ...
 * functionality should now be found in the new {@link TrayPreferenceFragment}
 ...
 * is associated with a {@link TrayPreferenceFragment} to display the preferences
 ...
 *
 * <p>See {@link TrayPreferenceFragment} for information on implementing the
 * fragments themselves.
 */
public abstract class TrayPreferenceActivity extends TrayListActivity implements
        TrayPreferenceManager.OnPreferenceTreeClickListener,
        TrayPreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    public static final class Header implements Parcelable {
         ...
         * {@link TrayPreferenceActivity#HEADER_ID_UNDEFINED}, meaning no id.
         * @attr ref R.styleable#PreferenceHeader_id
         */
        public long id = HEADER_ID_UNDEFINED;

        /**
         * Resource ID of title of the header that is shown to the user.
         * @attr ref R.styleable#PreferenceHeader_title
         */
        @StringRes
        public int titleRes;
         ...
         * @attr ref R.styleable#PreferenceHeader_summary
         */
        @StringRes
         ...
         * @attr ref R.styleable#PreferenceHeader_breadCrumbTitle
         */
        @StringRes
         ...
         * @attr ref R.styleable#PreferenceHeader_breadCrumbShortTitle
         */
        @StringRes
         ...
         * @attr ref R.styleable#PreferenceHeader_icon
         */
        public int iconRes;
         ...
         * selected.
         * @attr ref R.styleable#PreferenceHeader_fragment
         */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TypedArray sa = obtainStyledAttributes(null,
                R.styleable.TrayPreferencesActivity,
                R.attr.trayPreferenceActivityStyle,
                0);

        final int layoutResId = sa.getResourceId(
                R.styleable.TrayPreferencesActivity_layout,
        ...
        if (initialFragment != null && mSinglePane) {
            ...
            // of preferences" mode.
            setContentView(R.layout.traypreference_list_content_single_material);
            mListFooter = (FrameLayout) findViewById(R.id.list_footer);
            mPrefsContainer = (ViewGroup) findViewById(R.id.prefs);
            mPreferenceManager = new TrayPreferenceManager(this, FIRST_REQUEST_CODE);
            ...
            while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("header".equals(nodeName)) {
                    ...
                    TypedArray sa = obtainStyledAttributes(
                            attrs, R.styleable.TrayPreferencesHeader);
                    header.id = sa.getResourceId(
                            R.styleable.TrayPreferencesHeader_id,
                            (int)HEADER_ID_UNDEFINED);
                    TypedValue tv = sa.peekValue(
                            R.styleable.TrayPreferencesHeader_title);
                    ...
                    tv = sa.peekValue(
                            R.styleable.TrayPreferencesHeader_summary);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.TrayPreferencesHeader_breadCrumbTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.TrayPreferencesHeader_breadCrumbShortTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    header.iconRes = sa.getResourceId(
                            R.styleable.TrayPreferencesHeader_icon, 0);
                    header.fragment = sa.getString(
                            R.styleable.TrayPreferencesHeader_fragment);
                    sa.recycle();
    ...
    @Override
    public boolean onPreferenceStartFragment(TrayPreferenceFragment caller, TrayPreference pref) {
    ...
    /**
     * Returns the {@link TrayPreferenceManager} used by this activity.
     ...
     */
    @Deprecated
    public boolean onPreferenceTreeClick(TrayPreferenceScreen preferenceScreen, TrayPreference preference) {
        return false;
    }
